...
var project_data = [
  {   
      ...
      project_description  : "Swipe is a sample landing page for a brand. Swipe has various UI components including a pricing page, a page to display brand stats, a reveal footer as well. The sections have subtle animations when scrolled to, delivering an interactive dyanmic user experiance.",
  ...
  {   
      ...
      project_description  : "This is a single page sample portfolio website, The website uses bold as well as modern font language. Subtle scroll based animations help keep the user tethered to the portfolio, while promoting interactivity.  ",
  ...
  {   
      ...
      project_description  : "DetectD is a GAN based AI tool, to detect if the uploaded media is a deepfake. The user can upload a media file - a video or an image, and the platform will predict if the media shows signs of a deepfake and return a prediction as a percentage. ",
      tech_stack : ["HTML SCSS", "JAVASCRIPT" , "FLASK", "MS AZURE"],
      recognitions : ["Microsoft Imagine Cup - National Winner","Secured 97% Testing Accuracy ", "Indian Incubators - top 20 statrups"] ,
      img_count : 5,
  ...
  {   
      ...
      project_description  : "BrandLn is another brand landing page built using moder bold and strong fonts. The small animated elements make the page more lively while the hover and scroll effects promotes user ineractivity. This is a sample page.",
  ...
  {   
      ...
      project_description  : "This is a single static page with minimal effects and subtle animation. The website uses futurisitc elements and ecperiments with various layouts.",
      tech_stack : ["HTML", "SCSS", "JAVASCRIPT"],
  ...
  {   
      ...
      project_description: "Pixops is a web platform used to manipulate images. This platform uses the ML concept of GANs to manipulate images,like to colorise B/W images, fuse two images together, upscale image (increase the resolution by 4X), and also generate images by taking a prompt from user. ",
      tech_stack : ["HTML SCSS", " FLASK", "JAVASCRIPT"],
      recognitions : ["Colorise B/W images","Upscale Images"," Generate Images", "Fuse Two Images" ,"Best Final Year Project", ] ,
      img_count : 2,
    ...
    {   
      ...
      project_description  : "Syngen is an AI/ML web platform to generate huge synthetic datasets, meaning with dummy logical data. The platform can also be used to compare various machine learning algorithms on a dataset to predict the best algorithm for optimal results. ",
